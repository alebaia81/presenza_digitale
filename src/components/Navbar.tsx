    ...
    <div className="fixed top-0 inset-x-0 z-50 border-b border-border-primary bg-bg-primary/80 backdrop-blur-xl transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-3 xl:gap-4">
          <ThemeToggle />
          <a href={getWaLink(location.pathname)} target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-text-secondary hover:text-[#075E54] dark:hover:text-[#25D366] transition-colors flex items-center gap-2">
      ...
      {isMobileMenuOpen && (
        ...
        >
          ...
          <a href={getWaLink(location.pathname)} target="_blank" rel="noopener noreferrer" onClick={() => setIsMobileMenuOpen(false)} className="bg-[#075E54]/10 text-[#075E54] border border-[#075E54]/30 dark:bg-[#25D366]/10 dark:text-[#25D366] dark:border-[#25D366]/30 px-6 py-4 rounded-full text-center font-bold hover:bg-[#075E54]/20 dark:hover:bg-[#25D366]/20 transition-colors flex justify-center items-center gap-2 text-lg">
