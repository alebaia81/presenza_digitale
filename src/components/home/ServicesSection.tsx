    ...
    <section id="servizi" className="py-24 px-6 relative border-t border-white/5 bg-zinc-950">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 text-center md:text-left">
          ...
          <p className="text-xl text-zinc-300 max-w-2xl font-light">Non creiamo semplici siti vetrina, ma strumenti digitali studiati per superare i tuoi concorrenti e portare risultati concreti.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-auto md:auto-rows-[340px]">
          <m.div whileHover={{ scale: 0.98 }} className="md:col-span-2 bg-gradient-to-br from-zinc-900/80 to-zinc-900/30 border border-white/10 rounded-[2rem] p-8 md:p-10 relative overflow-hidden group shadow-lg">
          ...
          <div className="grid grid-rows-2 gap-6">
            <m.div whileHover={{ scale: 0.98 }} className="bg-zinc-900/50 border border-white/10 rounded-[2rem] p-6 relative overflow-hidden group">
              ...
              <div className="relative z-10 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-300 text-sm leading-relaxed font-light">L'80% degli utenti abbandona i siti lenti. Noi usiamo le tecnologie più veloci (React).</p>
                </div>
              </div>
            </m.div>
            <m.div whileHover={{ scale: 0.98 }} className="bg-zinc-900/50 border border-white/10 rounded-[2rem] p-6 relative overflow-hidden group">
              ...
              <div className="relative z-10 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-300 text-sm leading-relaxed font-light">Ti facciamo trovare prima su Google per le ricerche legate a Piacenza e provincia.</p>
                </div>
              </div>
            </m.div>
          </div>
          <m.div whileHover={{ scale: 0.98 }} className="md:col-span-3 bg-zinc-900/50 border border-white/10 rounded-[2rem] p-8 md:p-12 relative overflow-hidden group">
            ...
            <div className="relative z-10 h-full flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left will-change-transform">
              <div className="flex-1">
                ...
                <p className="text-zinc-300 text-lg leading-relaxed max-w-2xl font-light">
