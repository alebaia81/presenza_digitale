    ...
    <section id="contatti" className="py-24 px-6 relative bg-zinc-950 border-t border-white/5">
      ...
      <div className="max-w-6xl mx-auto relative z-10 grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-8">
           ...
           <p className="text-xl text-zinc-300 font-light">Non aspettare che i tuoi concorrenti prendano tutti i clienti della provincia. Contattaci oggi per una consulenza gratuita.</p>
        </div>
          ...
          <form id="contact-form" onSubmit={inviaWhatsApp} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-zinc-500" aria-hidden="true" />
            ...
            <div>
              <label htmlFor="message" className="block text-sm font-medium text-zinc-300 mb-2">Raccontaci il tuo progetto</label>
